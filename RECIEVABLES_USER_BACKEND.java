 ...
 * @author Myles
 */
public class RECIEVABLES_USER_BACKEND {
    
    public String courseNumber, courseCredit, courseName, courseCost;
   
    BOOLA_BOOLA_DB boolaDb;
    
    public RECIEVABLES_USER_BACKEND()
    {
   
    }
    
    public RECIEVABLES_USER_BACKEND(String courseNumber, String courseCredit, String courseName, String courseCost)
    {
